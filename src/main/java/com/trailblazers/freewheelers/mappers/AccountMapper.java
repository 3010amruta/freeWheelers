...
public interface AccountMapper {
    ...
    @Insert(
        "INSERT INTO account (account_name, email_address, password, phone_number, enabled, country_id) " +
        "VALUES (#{account_name}, #{emailAddress}, #{password}, #{phoneNumber}, #{enabled}, #{country_id})"
    )
    ...
    @Select(
        "SELECT account_id, account_name, email_address, password, phone_number, enabled, country_id FROM account"
    )
    @Results(value = {
